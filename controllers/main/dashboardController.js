...
export const getPowerWidgets = async (req, res) => {
    try {
        ...
        const d2 = await Dashboard.getD2Data(pool, meter_serial);
        const d3 = await Dashboard.getD3Data(pool, meter_serial);
        const d3_b3 = await Dashboard.getD3B3Data(pool, meter_serial);
